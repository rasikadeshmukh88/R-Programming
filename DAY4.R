...
# 1)An IF statement allows R to run a block of code only if a condition is TRUE.
...
# Change this number to test different outcomes
num <- 7   
...
item <- 22   # Try numeric, character, or logical values
